...
namespace Longbow.Models
{
  ...
  internal class SavedState
  {
    ...
    private static readonly AdvancedSetting DEFAULT_MAX_FPS = new("maxFPS", 60, true);
    private static readonly AdvancedSetting DEFAULT_VERIFY_AND_REPAIR_ADDONS = new("addonsRepair", true);
    private static readonly AdvancedSetting DEFAULT_USE_UPNP = new("useUpnp", true);
    private static readonly AdvancedSetting DEFAULT_USE_EXPERIMENTAL = new("useExperimental", false);
    private static readonly AdvancedSetting DEFAULT_LOAD_SESSION_SAVE = new("loadSessionSave", "", false);
    private static readonly AdvancedSetting DEFAULT_AUTO_RESTART_ON_CRASH = new("autoRestartOnCrash", false);
    private static readonly AdvancedSetting DEFAULT_AUTO_RELOAD = new("autoreload", 10, false);
    private static readonly AdvancedSetting DEFAULT_NO_BACKEND = new("noBackend", false);
    private static readonly AdvancedSetting DEFAULT_AUTO_SHUTDOWN = new("autoShutdown", false);
    private static readonly AdvancedSetting DEFAULT_LOG_VOTING = new("logVoting", false);
    private static readonly AdvancedSetting DEFAULT_OVERRIDE_PORT = new("bindPort", 2001, false);
    private static readonly AdvancedSetting DEFAULT_NETWORK_DYNAMIC_SIM = new("nds", 2, false);
    private static readonly AdvancedSetting DEFAULT_SPATIAL_MAP_RES = new("nwkResolution", 500, false);
    private static readonly AdvancedSetting DEFAULT_STAGGERING_BUDGET = new("staggeringBudget", 5000, false);
    private static readonly AdvancedSetting DEFAULT_STREAMING_BUDGET = new("streamingBudget", 500, false);
    private static readonly AdvancedSetting DEFAULT_STREAMS_DELTA = new("streamsDelta", 100, false);
    private static readonly AdvancedSetting DEFAULT_RPL_TIMEOUT_MS = new("rpl-timeout-ms", 10000, false);
    private static readonly AdvancedSetting DEFAULT_AI_PARTIAL_SIM = new("aiPartialSim", false);
    private static readonly AdvancedSetting DEFAULT_CREATE_DB = new("createDB", false);
    private static readonly AdvancedSetting DEFAULT_DEBUGGER_ADDRESS = new("debugger", "127.0.0.1", false);
    private static readonly AdvancedSetting DEFAULT_DEBUGGER_PORT = new("debuggerPort", 1000, false);
    private static readonly AdvancedSetting DEFAULT_DISABLE_SHADERS_BUILD = new("disableShadersBuild", false);
    private static readonly AdvancedSetting DEFAULT_GENERATE_SHADERS = new("generateShaders", false);
    private static readonly AdvancedSetting DEFAULT_RPL_ENCODE_AS_LONG_JOBS = new("rplEncodeAsLongJobs", false);
